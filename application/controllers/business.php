...
class Business extends CI_Controller {
    ...
    function PostBusiness()
    {
        ...
        $query_params = array(
            ...
            'business_telephone' => $_POST['btelp'],
            'business_handphone' => $_POST['bhandp'],
            'business_fax' => $_POST['bfax'],
            'business_email' => $_POST['bemail'],
            'business_facebook' => $_POST['bfb'],
            'business_twitter' => $_POST['btwt'],
            'business_web' => $_POST['bweb'],
